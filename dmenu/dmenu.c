...
/* enums */
enum { SchemeNorm, SchemeSel, SchemeHp, SchemeOut, SchemeNormHighlight, SchemeSelHighlight, SchemeMid, SchemeLast }; /* color schemes */
...
usage(void)
{
	fputs("usage: dmenu [-bfiPv] [-H histfile] [-l lines] [-h height] [-p prompt] [-fn font] [-m monitor]\n"
